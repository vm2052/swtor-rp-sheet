...
const state = {
    ...
    skills: [
        ...
        { id: 'authority', tier: 5, icon: 'icons/authority.webp', row: 0, col: 12,  rank: 0, type: 'normal', label: 'Authority', connectsTo: [] , effects: { xp: -4, rb: +1 }, description: 'This skill represents a character’s ability to utilise their actual or perceived status to influence and direct the actions of others. Such as through the issuing of orders. '},
        ...
        { id: 'psychological_warfare', tier: 4, icon: 'icons/psychological_warfare.png', row: 2, col: 12,  rank: 0, type: 'rb', label: 'Psychological Warfare', connectsTo: ['authority'] , description: 'This skill represents a character’s ability to intimidate, coerce and confuse others on a large scale, demoralising or changing the beliefs of entire target populations, such as through the use of propaganda.'},
       ...
       { id: 'cybernetics', tier: 1, icon: 'icons/cybernetics.png', row:8, rank: 0, col: 9, type: 'normal', label: 'Cybernetics', connectsTo: [], description: 'This skill represents a character’s ability to design and implement cybernetics into a living body. May also apply to the use of more complicated cybernetic functions. ' },
        ...
        { id: 'culture', tier: 1, icon: 'icons/culture.webp', row:7, col: 11, rank: 0, type: 'hp', label: 'Linguistics&History', connectsTo: ['diplomacy'], description: ' This skill represents a character’s ability to understand the norms and values of various cultures (inc. their own) as well as the character’s pre-existing knowledge of such. This can include: religious beliefs, cultural taboos, societal organisation and prejudices. The skill includes knowledge in History and Linguistics as well.' },
         { id: 'archeology', tier: 1, icon: 'icons/archeology.webp', row:8, col: 11, rank: 0, type: 'hp', label: 'Archeology', connectsTo: ['culture'], description: 'This skill represents a character’s ability to understand, remember and apply information about ancient civilisations. Such as by navigating tombs or identifying artefacts. ' },
         { id: 'diplomacy', tier: 1, icon: 'icons/diplomacy.png', row:7, col: 12, rank: 0, type: 'hp', label: 'Diplomacy', connectsTo: ['manupulation'], description:'This skill represents a character’s ability to negotiate with others using both reasoned arguments and a demeanour found to be appealing by the other party. ' },
       { id: 'persuasion', tier: 1, icon: 'icons/persuasion.webp', row:8, col: 12, rank: 0, type: 'hp', label: 'Persuasion', connectsTo: ['diplomacy'] , description: 'This skill represents a character’s ability to influence the actions of others through appeal and explanation. Such as through the application of rhetorical devices or evidence.'},
